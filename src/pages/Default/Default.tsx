          ...
          <Grid container rowSpacing={5}>
            <Grid item xs={6}>
              <InputBox
                ...
                setHeight={0} 
                title={"First Name"} 
                modalChildren={<p>Please enter your first name. You may include your middle name.</p>}
              />
            </Grid>
            <Grid item xs={6}>
              <InputBox
            ...
            <Grid item xs={6}>
              <InputBox
                ...
                modalChildren={
                    <div>
                        <div>
                            <p>Please enter the role you are using this tool as. This is used to make your proposal more customized and helps us know who our users are.</p>
                        </div>
                        <div>
            ...
            <Grid item xs={6}>
              <SelectDropdown 
                header="Region" 
                title={"Region"} 
                modalChildren={<p>Please click on the dropdown and select the region your project is closesly based in.</p>}/>
            </Grid>
          </Grid>
        </Box>
